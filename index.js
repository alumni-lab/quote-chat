...
app.get('/auth', async (req, res) => {
  ...
  getBotId(req.query.code, async (accessData) => {
    let dbadd = await client.query(`INSERT INTO auth (team_id, access_token, bot_access_token) VALUES (${accessData.team_id}, ${accessData.access_token}, ${accessData.bot_access_token})`);
    console.log(dbadd)
  })
  res.status(200)
})
